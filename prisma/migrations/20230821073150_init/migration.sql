...
CREATE TABLE "students" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "academcSemesterId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_academcSemesterId_fkey" FOREIGN KEY ("academcSemesterId") REFERENCES "academic_semesters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
