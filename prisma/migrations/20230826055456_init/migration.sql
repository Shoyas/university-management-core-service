/*
  ...
  - You are about to drop the column `academcSemesterId` on the `students` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "students" DROP CONSTRAINT "students_academcSemesterId_fkey";

-- AlterTable
ALTER TABLE "students" DROP COLUMN "academcSemesterId",
